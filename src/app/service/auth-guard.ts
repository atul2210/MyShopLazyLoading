...
export class authguard implements CanActivate
{
    ...
    returnUrl: string;
    constructor(@Inject(WINDOW) private window: Window, @Inject(LOCAL_STORAGE) private localStorage: any , private appservice:ShoppingApiService,private router:Router,private route:ActivatedRoute)
