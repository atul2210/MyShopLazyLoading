...
let PlaceOrderComponent = class PlaceOrderComponent {
    constructor(localStorage, totalItem, singleton, route, active, service) {
    ...
    Order() {
        ...
        ;
        let regis = new _model_registration__WEBPACK_IMPORTED_MODULE_6__["registration"]();
    ...
    SaveAddress() {
        let edit = new _model_registration__WEBPACK_IMPORTED_MODULE_6__["EditAddress"]();
...
let PlaceOrdersModule = class PlaceOrdersModule {
};
