(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-pages-new-user-activate-new-usre-activate-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NewUserActivateComponent = /** @class */ (function () {
                function NewUserActivateComponent(activate) {
                    this.activate = activate;
                }
                NewUserActivateComponent.prototype.ngOnInit = function () {
                    this.emailId = this.activate.getOption();
                };
                return NewUserActivateComponent;
            }());
            NewUserActivateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [{ path: '', component: _new_user_activate_component__WEBPACK_IMPORTED_MODULE_3__["NewUserActivateComponent"] },
            ];
            var NewUserActivateModule = /** @class */ (function () {
                function NewUserActivateModule() {
                }
                return NewUserActivateModule;
            }());
...
//# sourceMappingURL=app-pages-new-user-activate-new-usre-activate-module-es5.js.map
//# sourceMappingURL=app-pages-new-user-activate-new-usre-activate-module-es5.js.map