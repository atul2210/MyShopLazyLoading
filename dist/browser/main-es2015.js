    ...
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_10__["RouterModule"].forRoot([
                ...
                { path: 'login', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-login-login-module */ "app-pages-login-login-module").then(__webpack_require__.bind(null, /*! ../app/pages/login/login.module */ "./src/app/pages/login/login.module.ts")).then(m => m.LoginModule) },
                { path: 'welcome', loadChildren: () => __webpack_require__.e(/*! import() | app-welcome-welcome-module */ "app-welcome-welcome-module").then(__webpack_require__.bind(null, /*! ../app/welcome/welcome.module */ "./src/app/welcome/welcome.module.ts")).then(m => m.WelcomeModule) },
                ...
                { path: 'itemDetail/:itemid', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-itemdetails-itemdetail-module */ "app-pages-itemdetails-itemdetail-module").then(__webpack_require__.bind(null, /*! ../app/pages/itemdetails/itemdetail.module */ "./src/app/pages/itemdetails/itemdetail.module.ts")).then(m => m.ItemdetailsModule) },
                ...
                { path: 'checkin', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-checkin-checkin-module */ "app-pages-checkin-checkin-module").then(__webpack_require__.bind(null, /*! ../app/pages/checkin/checkin.module */ "./src/app/pages/checkin/checkin.module.ts")).then(m => m.CheckintModule) },
                { path: 'registration/:mobile', loadChildren: () => Promise.all(/*! import() | app-pages-user-registration-user-registration-module */[__webpack_require__.e("common"), __webpack_require__.e("app-pages-user-registration-user-registration-module")]).then(__webpack_require__.bind(null, /*! ../app/pages/user-registration/user-registration.module */ "./src/app/pages/user-registration/user-registration.module.ts")).then(m => m.UserRegistrationComponentModule) },
                ...
                { path: 'forgetpassword', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-foreget-password-forget-password-module */ "app-pages-foreget-password-forget-password-module").then(__webpack_require__.bind(null, /*! ../app/pages/foreget-password/forget-password.module */ "./src/app/pages/foreget-password/forget-password.module.ts")).then(m => m.ForgetPasswordModule) },
                { path: 'logout', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-logout-logout-module */ "app-pages-logout-logout-module").then(__webpack_require__.bind(null, /*! ../app/pages/logout/logout.module */ "./src/app/pages/logout/logout.module.ts")).then(m => m.LogoutModule) },
                { path: 'changepassword', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-changepassword-changepassword-module */ "app-pages-changepassword-changepassword-module").then(__webpack_require__.bind(null, /*! ../app/pages/changepassword/changepassword.module */ "./src/app/pages/changepassword/changepassword.module.ts")).then(m => m.ChangepasswordModule) },
                { path: 'Error/:message/:compo/:mobi', component: _pages_error_error_component__WEBPACK_IMPORTED_MODULE_33__["ErrorComponent"] },
                { path: 'ContactUs', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-contact-us-contactus-module */ "app-pages-contact-us-contactus-module").then(__webpack_require__.bind(null, /*! ../app/pages/contact-us/contactus.module */ "./src/app/pages/contact-us/contactus.module.ts")).then(m => m.ContactUsModule) },
                { path: 'PrivacyPolicy', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-privacy-policy-privacy-policy-modle */ "app-pages-privacy-policy-privacy-policy-modle").then(__webpack_require__.bind(null, /*! ../app/pages/privacy-policy/privacy-policy.modle */ "./src/app/pages/privacy-policy/privacy-policy.modle.ts")).then(m => m.PrivacyPolicyModule) },
                { path: 'AboutUs', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-about-us-module */ "app-pages-about-us-module").then(__webpack_require__.bind(null, /*! ../app/pages/about-us.module */ "./src/app/pages/about-us.module.ts")).then(m => m.AboutUsModule) },
                // {path: 'forgetpassword', loadChildren: () => import('../app/pages/foreget-password/forget-password.module').then(m => m.ForgetPasswordModule)},
                { path: 'Payment', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-payment-payment-module */ "app-pages-payment-payment-module").then(__webpack_require__.bind(null, /*! ../app/pages/payment/payment.module */ "./src/app/pages/payment/payment.module.ts")).then(m => m.PaymentModule) },
                { path: 'ShippingPolicy', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-shipping-policy-shipping-policy-module */ "app-pages-shipping-policy-shipping-policy-module").then(__webpack_require__.bind(null, /*! ../app/pages/shipping-policy/shipping-policy.module */ "./src/app/pages/shipping-policy/shipping-policy.module.ts")).then(m => m.ShippingPolicydModule) },
                { path: 'PlaceOrder/', loadChildren: () => Promise.all(/*! import() | app-pages-place-order-place-order-module */[__webpack_require__.e("common"), __webpack_require__.e("app-pages-place-order-place-order-module")]).then(__webpack_require__.bind(null, /*! ../app/pages/place-order/place-order.module */ "./src/app/pages/place-order/place-order.module.ts")).then(m => m.PlaceOrdersModule) },
                { path: 'PmtRecevdThanks', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-pmt-rcvt-thanks-pmt-rcvt-thanks-module */ "app-pages-pmt-rcvt-thanks-pmt-rcvt-thanks-module").then(__webpack_require__.bind(null, /*! ../app/pages/pmt-rcvt-thanks/pmt-rcvt-thanks.module */ "./src/app/pages/pmt-rcvt-thanks/pmt-rcvt-thanks.module.ts")).then(m => m.PmtRcvtThanksModule) },
                { path: 'NewUserActivate', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-new-user-activate-new-usre-activate-module */ "app-pages-new-user-activate-new-usre-activate-module").then(__webpack_require__.bind(null, /*! ../app/pages/new-user-activate/new-usre-activate.module */ "./src/app/pages/new-user-activate/new-usre-activate.module.ts")).then(m => m.NewUserActivateModule) },
        ...
        providers: [{ provide: _angular_common__WEBPACK_IMPORTED_MODULE_4__["LocationStrategy"], useClass: _angular_common__WEBPACK_IMPORTED_MODULE_4__["HashLocationStrategy"] }, _app_service_shopping_api_service__WEBPACK_IMPORTED_MODULE_8__["ShoppingApiService"], _model_global__WEBPACK_IMPORTED_MODULE_12__["Globals"],
            ...
            {
                provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"],
                useFactory: (service) => new _src_app_service_loading_indicator_service_service__WEBPACK_IMPORTED_MODULE_25__["LoadingIndicatorInterceptor"](service),
                multi: true,
...
let AppComponent = class AppComponent {
    constructor(loadingIndicatorService, restProvider, route) {
    ...
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_10__["RouterModule"].forRoot([
                ...
                { path: 'login', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-login-login-module */ "app-pages-login-login-module").then(__webpack_require__.bind(null, /*! ../app/pages/login/login.module */ "./src/app/pages/login/login.module.ts")).then(m => m.LoginModule) },
                { path: 'logout', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-logout-logout-module */ "app-pages-logout-logout-module").then(__webpack_require__.bind(null, /*! ../app/pages/logout/logout.module */ "./src/app/pages/logout/logout.module.ts")).then(m => m.LogoutModule) },
                { path: 'order-list', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-order-list-orders-module */ "app-pages-order-list-orders-module").then(__webpack_require__.bind(null, /*! ../app/pages/order-list/orders.module */ "./src/app/pages/order-list/orders.module.ts")).then(m => m.OrdersModule) },
                { path: 'PmtRecevdThanks', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-pmt-rcvt-thanks-pmt-rcvt-thanks-module */ "app-pages-pmt-rcvt-thanks-pmt-rcvt-thanks-module").then(__webpack_require__.bind(null, /*! ../app/pages/pmt-rcvt-thanks/pmt-rcvt-thanks.module */ "./src/app/pages/pmt-rcvt-thanks/pmt-rcvt-thanks.module.ts")).then(m => m.PmtRcvtThanksModule) },
                { path: 'NewUserActivate', loadChildren: () => __webpack_require__.e(/*! import() | app-pages-new-user-activate-new-usre-activate-module */ "app-pages-new-user-activate-new-usre-activate-module").then(__webpack_require__.bind(null, /*! ../app/pages/new-user-activate/new-usre-activate.module */ "./src/app/pages/new-user-activate/new-usre-activate.module.ts")).then(m => m.NewUserActivateModule) },
                { path: '**', component: _page_not_found_page_not_found_component_page_not_found_component_component__WEBPACK_IMPORTED_MODULE_11__["PageNotFoundComponentComponent"] }
            ], { onSameUrlNavigation: 'reload' }),
        ...
        providers: [{ provide: _angular_common__WEBPACK_IMPORTED_MODULE_4__["LocationStrategy"], useClass: _angular_common__WEBPACK_IMPORTED_MODULE_4__["HashLocationStrategy"] }, _app_service_shopping_api_service__WEBPACK_IMPORTED_MODULE_8__["ShoppingApiService"], _model_global__WEBPACK_IMPORTED_MODULE_12__["Globals"],
            ...
            {
                provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"],
                useFactory: (service) => new _src_app_service_loading_indicator_service_service__WEBPACK_IMPORTED_MODULE_24__["LoadingIndicatorInterceptor"](service),
                multi: true,
...
let HomepageComponent = class HomepageComponent {
    constructor(localStorage, router, search, globals, ShoppingApiService, CartItemServiceService, totalItem, loadingIndicatorService, service) {
...
let DynamicMenuComponent = class DynamicMenuComponent {
    constructor(localStorage, router, http, service, search) {
        this.localStorage = localStorage;
        this.router = router;
        this.http = http;
        this.service = service;
...
let FirstTimeUserComponent = class FirstTimeUserComponent {
    constructor(activeservice, ShoppingApiService, router) {
...
FirstTimeUserComponent.ctorParameters = () => [
...
let HomeComponent = class HomeComponent {
    constructor(responseData, ShoppingApiService, service, loadingIndicatorService, devideDetect, titleService, metaService) {
...
let SearchResultComponent = class SearchResultComponent {
    constructor(responseData, router, route, service, MenuServiceService) {
        /*
...
let TempRouteComponent = class TempRouteComponent {
...
TempRouteComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
...
let authguard = class authguard {
    constructor(window, localStorage, appservice, router, route) {
        this.window = window;
        this.localStorage = localStorage;
...
let CartItemServiceService = class CartItemServiceService {
    constructor() { }
};
...
let HttpXsrfInterceptor = class HttpXsrfInterceptor {
    constructor(localStorage, tokenExtractor) {
        this.localStorage = localStorage;
...
let LoadingIndicatorInterceptor = class LoadingIndicatorInterceptor {
    ...
    intercept(req, next) {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["finalize"])(() => this.loadingIndicatorService.onFinished(req)));
    }
};
LoadingIndicatorInterceptor.ctorParameters = () => [
...
let LoadingIndicatorServiceService = class LoadingIndicatorServiceService {
    constructor() {
...
let SearchServiceService = class SearchServiceService {
    ...
    SearchResult(searchItem, pageindex, pagesize) {
        let querystring;
    ...
    //   }
    SearchItems(page, pagesize, searchItem, saveResultsCallback) {
        let querystring;
        this.uri = this.baseUrl + "/api/items/";
        querystring = "?Page=" + page + "&Count=" + pagesize + "&IsPagingSpecified=true&IsSortingSpecified=true&itemSearch=" + searchItem;
        return this.http.get(this.uri + "SearchItem/" + querystring).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["skipWhile"])(() => this.httpReqestInProgress), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(() => { this.httpReqestInProgress = true; }))
            .subscribe((news) => {
            this.currentPage++;
    ...
    GetItems(page = 1, pagesize, saveItemResultsCallback) {
        let querystring;
        this.uri = this.baseUrl + "/api/items/";
        querystring = "?Page=" + this.ItemcurrentPage + "&Count=" + pagesize + "&IsPagingSpecified=true&IsSortingSpecified=true";
        return this.http.get(this.uri + "AllItemsOnPaging" + querystring).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["skipWhile"])(() => this.httpItemReqestInProgress), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(() => { this.httpItemReqestInProgress = true; }))
            .subscribe((ItemArray) => {
    ...
    GetItemsonPaging(page = 1, pagesize) {
        let querystring;
        this.uri = this.baseUrl + "/api/items/";
        querystring = "?Page=" + this.ItemcurrentPage + "&Count=" + pagesize + "&IsPagingSpecified=true&IsSortingSpecified=true";
        if (this.request$) {
    ...
    AllItems(ChildMenuId, CategoryPageIndex, pagesize, saveCategoryItemResultsCallback) {
        let querystring;
        this.uri = this.baseUrl + "/api/items/";
        ...
        return this.http.get(this.uri + "AllItems" + querystring).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["skipWhile"])(() => this.categoryhttpItemReqestInProgress), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(() => { this.categoryhttpItemReqestInProgress = true; }))
            .subscribe((categoryItemArray) => {
...
let serviceintercepter = class serviceintercepter {
    constructor(localStorage, document, http) {
        this.localStorage = localStorage;
...
serviceintercepter.ctorParameters = () => [
...
let ShoppingApiService = class ShoppingApiService {
    constructor(localStorage, http, responseData) {
        this.localStorage = localStorage;
        this.http = http;
        this.responseData = responseData;
    ...
    AllItems(category, index) {
        this.uri = this.baseUrl + "/api/items/";
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('categoryId', category).set("pageIndex", index);
        return this.http.get(this.uri + "AllItems/", { observe: 'response', params }).pipe(
        ///  catchError(this.handleError )
        );
    }
    itemDetails(itemId) {
        this.uri = this.baseUrl + "/api/items/";
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('itemId', itemId);
        return this.http.get(this.uri + "itemDetail/", { observe: 'response', params }).pipe(
        // catchError(this.handleError )
        );
    }
    ...
    getCheckedInItem(sessionId) {
        let querystring;
        ////let sessionToken:string
        this.uri = this.baseUrl + "/api/items/";
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('userSession', sessionId);
        return this.http.get(this.uri + "getcheckedinItem", { observe: 'response', params }).pipe(
        //catchError(this.handleError)
        );
    }
    RemoveItem(itemid, quantity, sessionId, checkinid) {
        let querystring;
    ...
    Login(userId, password) {
        ...
        return this.http.get(this.uri, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])((res) => {
    ...
    GetHomePageItems(pagesize, pageindex) {
        let querystring;
        this.uri = this.baseUrl + "/api/items/";
    ...
    addUser(user) {
        ...
        return this.http.post(this.uri, {
            ...
            headers: headers
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(this.handError), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])((res) => {
    ...
    getOTP(mobile) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            return yield this.http.get(this.uri, { observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])((res) => {
            }))
                .toPromise();
        });
    }
    ...
    ;
    paymentreceive(session, registration) {
    ...
    GetAddress(sessionId) {
        ...
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('usersession', sessionId);
        return this.http.get(this.uri + "Address", { observe: 'response', params }).pipe(
        // catchError(this.handleError )
        );
    }
    GetStates() {
...
let optResponse = class optResponse {
...
SingletonService.ctorParameters = () => [
