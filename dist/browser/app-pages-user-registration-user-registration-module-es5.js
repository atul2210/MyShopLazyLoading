(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-pages-user-registration-user-registration-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserRegistrationComponent = /** @class */ (function () {
                function UserRegistrationComponent(localStorage, ActivatedRoute, router, ShoppingApiService, activateuserservce) {
                ...
                UserRegistrationComponent.prototype.createFormControls = function () {
                ...
                UserRegistrationComponent.prototype.createForm = function () {
                ...
                UserRegistrationComponent.prototype.save = function () {
                    ...
                    if (this.myform.valid) {
                        var data_1;
                        data_1 = new _model_registration__WEBPACK_IMPORTED_MODULE_4__["registration"]();
                        data_1.mobile = this.myform.controls['mobile'].value;
                        data_1.ulternateMobile = this.myform.controls["ulternatemobile"].value;
                        data_1.firstName = this.myform.controls["firstName"].value;
                        data_1.middleName = this.myform.controls["middleName"].value;
                        data_1.lastName = this.myform.controls["lastName"].value;
                        data_1.myemail = this.myform.controls["myemail"].value;
                        data_1.password = this.myform.controls["password"].value;
                        data_1.address = this.myform.controls["address"].value;
                        data_1.city = this.myform.controls["city"].value;
                        data_1.mystate = this.myform.controls["mystate"].value;
                        data_1.pin = this.myform.controls["pin"].value;
                        data_1.otp = +this.myform.controls["otp"].value;
                        this.activateuserservce.setOption('email', this.myform.controls["myemail"].value);
                        this.ShoppingApiService.addUser(data_1)
                            .subscribe(function (m) {
                            _this.response = m;
                            _this.router.navigateByUrl('/NewUserActivate');
                        }, function (err) {
                            console.log(err);
                            _this.router.navigateByUrl("/Error/" + err.error.Message + "/regis/" + data_1.mobile);
                        });
                    }
                };
                UserRegistrationComponent.prototype.GetCities = function (StateId) {
                    var _this = this;
                    this.ShoppingApiService.GetCities(StateId)
                        .subscribe(function (res) {
                        _this.citeis = res.body;
                        console.log(_this.citeis);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [{ path: '', component: _user_registration_component__WEBPACK_IMPORTED_MODULE_3__["UserRegistrationComponent"] },
            ];
            var UserRegistrationComponentModule = /** @class */ (function () {
                function UserRegistrationComponentModule() {
                }
                return UserRegistrationComponentModule;
            }());
...
//# sourceMappingURL=app-pages-user-registration-user-registration-module-es5.js.map
//# sourceMappingURL=app-pages-user-registration-user-registration-module-es5.js.map