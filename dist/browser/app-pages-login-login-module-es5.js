...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-pages-login-login-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(localStorage, route, loadingIndicatorService, router, authguard, http, fb, location, itemService) {
                    var _this = this;
                ...
                LoginComponent.prototype.populateTestData = function () {
                };
                LoginComponent.prototype.onSubmit = function () {
                    var _this = this;
                    var userid = this.loginForm.controls["username"].value;
                    var password = this.loginForm.controls["password"].value;
                    this.http.Login(userid, password)
                        .subscribe(function (data) {
                        _this.isOk = false;
                        _this.http.userFullName(data.fullname);
                        _this.err = "";
                        ////  this.location.back();
                        var itemid = _this.itemService.itemIdLogin;
                        if (itemid != 0) {
                            _this.router.navigateByUrl("/itemDetail/" + itemid);
                        }
                        else {
                    ...
                    (function (err) {
                        _this.isOk = true;
                        _this.localStorage.setItem("id_token", '');
                        _this.err = err.statusText;
                    });
                    this.isOk = true;
                    this.err = "Invalid User Id or Password";
                    // <-- go back to previous location
                };
                LoginComponent.prototype.openModalDialog = function () {
                    this.display = 'block'; //Set block css
                    this.loginForm.controls["mobileNumber"].patchValue('');
                    this.isOk = false;
                    return false;
                };
                LoginComponent.prototype.closeModel = function () {
                    this.display = 'none';
                    //this.mobile="";
                ...
                LoginComponent.prototype.closeModalDialog = function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    if (!(this.mobile.trim() != "")) return [3 /*break*/, 2];
                                    return [4 /*yield*/, this.http.getOTP(this.mobile)
                                            .then(function (res) {
                                            resp = res;
                                            _this.isOk = false;
                                            _this.display = 'none'; //set none css after close dialog
                                            _this.router.navigateByUrl("/registration/" + _this.mobile);
                                        })
                                            .catch(function (err) {
                                            _this.isOk = true;
                                            _this.err = err;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var tokenParams = /** @class */ (function () {
...
//# sourceMappingURL=app-pages-login-login-module-es5.js.map
//# sourceMappingURL=app-pages-login-login-module-es5.js.map