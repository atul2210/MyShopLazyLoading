...
let ShippingPolicyComponent = class ShippingPolicyComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
const routes = [{ path: '', component: _shipping_policy_component__WEBPACK_IMPORTED_MODULE_3__["ShippingPolicyComponent"] },
];
let ShippingPolicydModule = class ShippingPolicydModule {
};
