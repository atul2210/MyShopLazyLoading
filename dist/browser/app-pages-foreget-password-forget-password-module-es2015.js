...
let ForegetPasswordComponent = class ForegetPasswordComponent {
    ...
    SendMail() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (email.trim() != "") {
                let res = yield this.http.ResetPassword(email)
...
ForegetPasswordComponent.ctorParameters = () => [
...
const routes = [{ path: '', component: _foreget_password_component__WEBPACK_IMPORTED_MODULE_3__["ForegetPasswordComponent"] },
];
