(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-pages-itemdetails-itemdetail-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [{ path: '', component: _itemdetails_component__WEBPACK_IMPORTED_MODULE_3__["ItemdetailsComponent"] },
            ];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ItemdetailsComponent = /** @class */ (function () {
                function ItemdetailsComponent(window, localStorage, restProvider, HomepageComponent, route, globals, router, CartItemServiceService, inotify, loadingIndicatorService, itemService) {
                    var _this = this;
                    this.window = window;
                ...
                ItemdetailsComponent.prototype.ngOnInit = function () {
                    ...
                    this.restProvider.itemDetails(this.itemid)
                        ...
                        if (data.body.availableQty > 0) {
                            ...
                            _this.itemDetail = Array.of(data.body);
                            // //   ///this.colorDetail =data.body.availableColor.split(";")
                            // //  // this.colorname=this.colorDetail[0]
                            _this.price = data.body.price;
                            _this.offerprice = data.body.offerPrice;
                            _this.deliverycharges = data.body.deliveryCharges;
                            _this.coloId = data.body.colorId;
                            _this.sizeName = data.body.sizeName;
                            _this.category = data.body.categoryName;
                            _this.brand = data.body.brand;
                            _this.availableQty = data.body.availableQty;
                ...
                ItemdetailsComponent.prototype.overTitle = function () {
                ...
                ItemdetailsComponent.prototype.addToCart = function () {
                    ...
                    if (idToken) {
                        ...
                        this.restProvider.addToCart(this.itemid, '1')
                            .subscribe(function (data) {
                            _this.inotify.totalCartItem = data.count;
                            _this.notifyTotalItem(_this.inotify);
                            _this.router.navigateByUrl('/checkin');
                        }, function (err) {
                            _this.localStorage.removeItem("id_token");
                            _this.localStorage.removeItem("expires_at");
                            _this.localStorage.removeItem("fullName");
                            _this.localStorage.removeItem("email");
                ...
                ItemdetailsComponent.prototype.getColor = function (colorName) {
                    this.colorname = colorName;
                };
                ItemdetailsComponent.prototype.notifyTotalItem = function (totalItem) {
                    this.restProvider.changeSelectedItem(totalItem);
                };
                ItemdetailsComponent.prototype.onResize = function (event) {
...
//# sourceMappingURL=app-pages-itemdetails-itemdetail-module-es5.js.map
//# sourceMappingURL=app-pages-itemdetails-itemdetail-module-es5.js.map